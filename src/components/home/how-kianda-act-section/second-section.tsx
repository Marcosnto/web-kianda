...
export function SecondSection() {
  ...
  return (
    <HomePageSection id="howKiandaAct" className="mb-5">
      ...
      <div className="fullHD:!gap-x-[25px] mb-[87.5px] hidden w-full flex-wrap gap-x-3 gap-y-[58px] md:flex md:justify-center md:justify-items-center 2xl:gap-9 [@media(min-width:810px)]:gap-x-[34px] [@media(min-width:90rem)]:gap-x-[120px]">
        {whatKiandaDoCards.map((card) => (
          <StaticCard
            key={card.id}
            imageAlt={card.imageAlt}
